...
<DataRoot FormatVersion="1" ContentVersion="8.0.8.1" FileName="">
    <Objects>
        ...
        <DefaultRun>
            <Attributes>
                <AttrObjectColor>
                    <Data v="[1.000000,1.000000,1.000000,1.000000]" t="2" />
                    <Type v="DataTypeColor" t="3" />
                </AttrObjectColor>
                <AttrSimulationRunAgentFilter>
                    <Data>
                        <AgentFilterType v="AgentFilterAllAgents" t="3" />
                    </Data>
                    <Type v="DataTypeAgentFilter" t="3" />
                </AttrSimulationRunAgentFilter>
                <AttrSimulationRunAgentFilterEnabled>
                    <Data v="0" t="0" />
                    <Type v="DataTypeBool" t="3" />
                </AttrSimulationRunAgentFilterEnabled>
                <AttrSimulationRunAgentFilterMode>
                    <Data>
                        <EnumString v="AgentFilterColor" t="3" />
                        <EnumValue v="0" t="1" />
                    </Data>
                    <Type v="DataTypeEnum" t="3" />
                </AttrSimulationRunAgentFilterMode>
                <AttrSimulationRunBaseColor>
                    <Data>
                        <First>
                            <Data>
                                <EnumString v="ColorDatabase" t="3" />
                                <EnumValue v="2" t="1" />
                            </Data>
                            <Type v="DataTypeEnum" t="3" />
                        </First>
                    ...
                    <Type v="DataTypePair" t="3" />
                </AttrSimulationRunBaseColor>
                <AttrSimulationRunDatabaseFileName>
                    <Data v="C:/Paki/paki/Engineering/Masters/Pakinam Thesis/Project One Lab Trial/DefaultRun.mmdb" t="3" />
                    <Type v="DataTypeString" t="3" />
                </AttrSimulationRunDatabaseFileName>
                <AttrSimulationRunFilterColor>
                    <Data>
                        <First>
                            <Data>
                                <EnumString v="ColorUserSpecified" t="3" />
                                <EnumValue v="0" t="1" />
                            </Data>
                            <Type v="DataTypeEnum" t="3" />
                        </First>
                        <Second>
                            <Data v="[0.000000,0.500000,0.000000,1.000000]" t="2" />
                            <Type v="DataTypeColor" t="3" />
                        </Second>
                    </Data>
                    <Type v="DataTypePair" t="3" />
            ...
            <Body>
                <Geometry>
                    <GeometryType v="FrameGeometry" t="3" />
                </Geometry>
            </Body>
            <GlobalID v="5ccadba9-3f3e-461b-823f-71c83754a117" t="3" />
            <ID v="36" t="1" />
            <Name v="DefaultRun" t="3" />
            <ObjectSubType v="SimulationRun" t="3" />
            <ObjectType v="SimulationRun" t="3" />
        </DefaultRun>
        <Floor1>
            <Attributes>
                <AttrDrawObstacleMap>
        ...
        <Timetable>
            <Attributes>
                ...
                <AttrTimetableBasePath>
                    <Data v="C:/Paki/paki/Engineering/Masters/Pakinam Thesis/Project One Lab Trial/base" t="3" />
                    <Type v="DataTypeString" t="3" />
                </AttrTimetableBasePath>
                ...
                <AttrTimetableScheduleData>
                    <Data v="From,To,Population,Time Offset,Curve,Avatar or Color,Profile,Init Action,Give Tokens...&#x0A;Portal_A2,Portal_Street1,80,,,Red&#x0A;" t="3" />
                    <Type v="DataTypeBuffer" t="3" />
                </AttrTimetableScheduleData>
                <AttrTimetableScheduleFile>
                    <Data v="Agents schedule comparison .csv" t="3" />
                    <Type v="DataTypeString" t="3" />
                </AttrTimetableScheduleFile>
                <AttrTimetableScheduleTimestamp>
                    <Data v="2019-05-12 15:19:29" t="3" />
                    <Type v="DataTypeDate" t="3" />
                </AttrTimetableScheduleTimestamp>
            </Attributes>
            <GlobalID v="8f115dab-c7af-4671-a080-f5bf5852daec" t="3" />
            <ID v="35" t="1" />
        ...
        <Zone_Platform>
            <Attributes>
                ...
                <AttrObjecAttrTimetableScheduleDatatColor>
                    <Data v="[0.584000,0.729000,0.788000,1.000000]" t="2" />
                    <Type v="DataTypeColor" t="3" />
                </AttrObjectColor>
                <AttrSourceObject>
